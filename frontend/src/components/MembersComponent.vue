    ...
    <div class="header">
      ...
      <div class="sub-header">
        <div class="search-box">
          <input placeholder="Search" class="search" variant="outlined" />
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
            fill="currentColor"
            class="bi bi-search seacrh-icon"
            viewBox="0 0 16 16"
          >
            <path
        ...
        <div>
          <v-btn class="btn" prepend-icon="mdi-plus"> Add Member </v-btn>
        </div>
      </div>
    </div>
    <div>
...
<script lang="ts">
import MemberItem from "./home/MemberItem.vue";
...
.search {
  width: 12rem;
  outline-color: rgba(186, 162, 249, 1);
  color: rgba(186, 162, 249, 1);
  padding: 0.4rem;
  border: 1px solid rgba(186, 162, 249, 1);
  border-radius: 4px;
  font-size: 1rem;
}
.search:focus {
